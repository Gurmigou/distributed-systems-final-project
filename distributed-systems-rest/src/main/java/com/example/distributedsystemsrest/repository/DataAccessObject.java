package com.example.distributedsystemsrest.repository;
...
public class DataAccessObject {
    ...
    public void createNewStudent(Student student) {
        ...
        try {
            PreparedStatement ps = connection.prepareStatement("INSERT INTO student (firstName, lastName, group_id) VALUES (?, ?, ?)");
    ...
    public void updateStudent(Student student) {
        ...
        try {
            PreparedStatement ps = connection.prepareStatement("UPDATE student SET firstName = ?, lastName = ?, group_id = ? WHERE id = ?");
            ps.setString(1, student.firstName);
            ps.setString(2, student.lastName);
            ps.setInt(3, student.group.id);
